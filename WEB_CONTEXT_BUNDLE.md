...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-88137cdfa4e6aaf3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-88137cdfa4e6aaf3",
        "url": "https://en.wikipedia.org/wiki/Pierce%E2%80%93Birkhoff_conjecture"
      },
      {
        "retrieved_at": "2026-09-02T00:06:33Z",
    ...
    "statement": {
      "language": "en",
      "text": "Pierce–Birkhoff conjecture : every piecewise-polynomial $f:\\mathbb {R} ^{n}\\rightarrow \\mathbb {R} $ is the maximum of a finite set of minimums of finite collections of polynomials.",
      "version": 1
    },
    "title": "Pierce–Birkhoff conjecture",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "e3d26b014a746f6fe5f1d72ce7065d4991ff4f2af55940dffca32058b4fb068f"
}
```
